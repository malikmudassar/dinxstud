            ...
            <div class="col-md-12 grid-margin">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form action="/events/chooseHall" class="forms-sample" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-holder"> 
                      <br />
                        ...
                        <?php
                          foreach($menu_options as $menu_option) {
                              if(str_contains($menu_option->name, 'Bar')){
                                if(isset($tblcompany_barOption_id) && $tblcompany_barOption_id==0){$tblcompany_barOption_id=55;}
                                else{$tblcompany_barOption_id=$menu_option->id;}  
                        ?>
                    ...
                    <?php } ?>
                    <br />
                    <input type="button" class="btn btn-light" onclick="document.location='/events/new'" value="Previous" />
