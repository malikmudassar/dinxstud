            ...
            <div class="col-md-12 grid-margin">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form action="/events/lighting" method="post" enctype="multipart/form-data">
                  <div class="form-row">
                    ...
                    <input type="button" class="btn btn-light" onclick="document.location='/events/stage'" value="Previous" />
                  </form>
                </div>
              </div>
            </div>
