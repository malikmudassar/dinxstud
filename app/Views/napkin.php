            ...
            <div class="col-md-12 grid-margin">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form action="/events/napkin" method="post" enctype="multipart/form-data">
                  ...
                  ?>
                    ...
                    <br />
                    <input type="button" class="btn btn-light" onclick="document.location='/events/floorplan'" value="Previous" />
