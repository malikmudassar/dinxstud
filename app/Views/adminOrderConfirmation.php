...
<div class="main-panel">
    ...
    <form action="/AdminEvents/orderConfirmation" method="post" enctype="multipart/form-data">
        <div class="row">
...
<div class="col-md-12 grid-margin stretch-card">
    ...
    <div class="card-body">
        ...
        <table width=100%>
            ...
            <button type="submit" class="btn btn-primary mr-2"><?php 
            ...
            <button type="button" onclick="document.location='/AdminEvents/new'" class="btn btn-dark">MODIFY ORDER</button>
            <button type="button" onclick="document.location='/AdminEvents/reset'" class="btn btn-dark">RESET SELECTION</button>
            </td>
            </tr>
...
<tr height="30" bgcolor="#E6E6E6" style="text-align:right; font-family: Arial, Helvetica, sans-serif">
<td>&nbsp;</td>
<td style="border-bottom: 1px solid black">Flowers:</td>
  <td style="border-bottom: 1px solid black">&nbsp;</td>
  <td style="border-bottom: 1px solid black"><?php if ($flowers_price==0) { echo "Included!"; } else { echo "$".number_format($flowers_price, 2, ".", ","); } ?></td>
</tr>
<tr height="30" bgcolor="#E6E6E6" style="text-align:right; font-family: Arial, Helvetica, sans-serif">
<td>&nbsp;</td>
