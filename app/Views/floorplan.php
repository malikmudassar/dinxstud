            ...
            <div class="col-md-12 grid-margin">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form action="/events/floorplan" method="post" enctype="multipart/form-data">
                  ...
                  <?php
                    ...
                    <input type="button" class="btn btn-light" onclick="document.location='/events/menuItems'" value="Previous" />
                    <?php }else{ ?>
                    <input type="button" class="btn btn-light" onclick="document.location='/events/chooseHall'" value="Previous" />
                    <?php } ?>
