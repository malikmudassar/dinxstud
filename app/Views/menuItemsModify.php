  ...
  <div class="content-wrapper">
    <div class="row">
      ...
      <div class="col-md-6 grid-margin stretch-card">
        <div class="card">
                <div class="card-body">
                <form action="/ModifyEvent/menuItems" method="post" enctype="multipart/form-data">
                 
                  <h4 class="card-title"><?=$_SESSION["MODIFYEVENTS"]["STEP-2"]["label"]["selected_menuOption"]?></h4>
                  ...
                  ?>
                    ...
                    <h4 class="card-title"><?=$_SESSION["MODIFYEVENTS"]["STEP-2"]["label"]["selected_barOption"]?></h4>
                    <?php
