            ...
            <div class="col-md-12 grid-margin">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form action="/AdminEvents/chooseHall" class="forms-sample" method="post" enctype="multipart/form-data">
                    
                    
                    <div class="form-row">
                      <div class="form-holder" style="width:88%;"> 
                      ...
                      <div class="form-holder" style="padding:10px 0px !important; width:88%;"> 
                    ...
                    <?php } ?>
                    <br />
                    <input type="button" class="btn btn-light" onclick="document.location='/AdminEvents/new'" value="Previous" />
