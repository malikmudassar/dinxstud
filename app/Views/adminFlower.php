            ...
            <div class="col-md-12 grid-margin">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form action="/AdminEvents/flower" method="post" enctype="multipart/form-data">
                  <div class="form-row">
                  <?php
                    ...
                    <br />
                    <input type="button" class="btn btn-light" onclick="document.location='/AdminEvents/tableCloth'" value="Previous" />
