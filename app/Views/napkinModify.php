            ...
            <div class="col-md-12 grid-margin">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form action="/ModifyEvent/napkin" method="post" enctype="multipart/form-data">
                  ...
                  ?>
                      ...
                      <div class="form-holder" style="padding-left:10px" id="<?php echo $_SESSION["MODIFYEVENTS"]["STEP-2"]["label"]["selected_eventType"]; ?>" > 
                        
                        <input style="vertical-align:top; margin-top:5px" name="<?php echo $name; ?>" id="napkin_<?=$napkin->id?>" type="<?php echo $inputType; ?>" <?php if (isset($napkin_selected) && str_contains($napkin_selected,$napkin->id)) echo "checked"; ?> value="<?=$napkin->id?>" onclick="checkLength()" />
                        &nbsp;&nbsp;
                    ...
                    <br />
                    <input type="button" class="btn btn-light" onclick="document.location='/ModifyEvent/floorplan'" value="Previous" />
