            ...
            <div class="col-md-12 grid-margin">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form action="/ModifyEvent/new" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-holder" style="padding-left:2%; padding-bottom:10px !important; width:54%; display:none;" id="valid_licensed_bar_image">
                        ...
                        <label for="own_license">Upload own licence if applicable?</label>
                          ...
                          ?>
                            ...
                            <br /><p style="padding-top: 14px"><a target="_blank" href='<?=$_SESSION["MODIFYEVENTS"]["STEP-1"]["own_license_file"]?>'>View File</a></p>
