...
<div class="main-panel">
    ...
    <form action="/events/orderConfirmation" method="post" enctype="multipart/form-data">
        <div class="row">
...
<div class="col-md-12 grid-margin stretch-card">
    ...
    <div class="card-body">
        ...
        <table width=100%>
            ...
            <button type="button" onclick="document.location='/events/new'" class="btn btn-dark">MODIFY ORDER</button>
            <button type="button" onclick="document.location='/events/reset'" class="btn btn-dark mt-2">RESET SELECTION</button>
            </td>
            </tr>
