<!-- content-wrapper ends -->
  ...
  <script src="/admin/js/tinymce/models/dom/model.min.js"></script>
  <script src="/admin/js/tinymce/themes/silver/theme.min.js"></script>
  <script src="/admin/js/tinymce/icons/default/icons.min.js"></script>
  ...
  <?php
    if ((strpos($_SERVER["PATH_INFO"], "buffetPricing/")!==false) &&
        (strpos($_SERVER["PATH_INFO"], "add")!==false)) {
  ?>
    <script>
